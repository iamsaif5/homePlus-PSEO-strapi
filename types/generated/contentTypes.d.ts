...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Site: Schema.Attribute.Enumeration<
      ['homeplus', 'truckwys', 'baselinq', 'techstyles', 'tradepilot']
    > &
      Schema.Attribute.Required;
...
export interface ApiHomeplusArticleHomeplusArticle
  extends Struct.CollectionTypeSchema {
  collectionName: 'homeplus_articles';
  info: {
    displayName: 'homeplus-article';
    pluralName: 'homeplus-articles';
    singularName: 'homeplus-article';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiLocationCollectionLocationCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'location_collections';
  info: {
    displayName: 'Location Collection';
    pluralName: 'location-collections';
    singularName: 'location-collection';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTradeCollectionTradeCollection
  extends Struct.CollectionTypeSchema {
  collectionName: 'trade_collections';
  info: {
    displayName: 'Trade collection';
    pluralName: 'trade-collections';
    singularName: 'trade-collection';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTradepilotArticleTradepilotArticle
  extends Struct.CollectionTypeSchema {
  collectionName: 'tradepilot_articles';
  info: {
    displayName: 'tradepilot-article';
    pluralName: 'tradepilot-articles';
    singularName: 'tradepilot-article';
  };
  options: {
    draftAndPublish: true;
  };
